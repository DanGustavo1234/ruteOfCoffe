# Generated by Django 4.1.3 on 2022-11-13 13:41
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo_emprendimiento', models.CharField(choices=[('hospedaje', 'Hospedaje'), ('gastronomia', 'Gastronomia'), ('spots', 'Spot Turistico'), ('productores', 'Productor - Vendedor')], max_length=200, verbose_name='Tipo de Emprendimiento')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('persona_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='projects.persona')),
                ('emprendimientos', models.ManyToManyField(blank=True, to='projects.emprendimiento')),
            ],
            options={

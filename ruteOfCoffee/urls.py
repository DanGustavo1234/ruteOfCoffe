"""ruteOfCoffee URL Configuration
...
urlpatterns = [
    ...
    path('reservas/reservas.html/<int:id>', views.reserva, name="reservas"),
    # path('reservas/reservas.html/<int:id>', views.reservas_get, name="reservas_get"),
